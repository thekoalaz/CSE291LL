...
Our next steps are to implement the prefiltering and warping of the environment maps which will be headed by Kevin, and continue working on the shader so that we can integrate over the full environment map.
